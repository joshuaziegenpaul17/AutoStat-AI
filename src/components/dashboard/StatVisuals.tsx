...
import { 
  ...
  PieChart, Pie, Cell, ComposedChart, Treemap, RadarChart, PolarGrid, PolarAngleAxis, PolarRadiusAxis, Radar
} from 'recharts';
...
export const StatVisuals: React.FC<StatVisualsProps> = ({ data, numericColumns, categoricalColumns }) => {
  ...
  if (numericColumns.length === 0) return (
    <div className="p-20 text-center border-dashed border-2 border-white/10 rounded-3xl">
      <p className="text-white/20 uppercase tracking-[0.4em] text-sm font-bold">No data available for visualization.</p>
    </div>
  );
